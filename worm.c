...
void initializeColors() {
    ...
    init_pair(COLP_FOOD_1, COLOR_YELLOW, COLOR_WHITE);
    init_pair(COLP_FOOD_2, COLOR_MAGENTA, COLOR_WHITE);
    init_pair(COLP_FOOD_3, COLOR_CYAN, COLOR_WHITE);
    init_pair(COLP_BARRIER, COLOR_RED, COLOR_WHITE);
}
